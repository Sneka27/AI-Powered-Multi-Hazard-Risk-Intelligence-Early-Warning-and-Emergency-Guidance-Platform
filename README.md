...
Live Platform · API Docs · Legal · Technical Report
...
Composite Scoring — Dominant hazard weighting with diminishing secondary contributions, province-specific hazard weights
Explainability — Deterministic feature importance computed from the same thresholds used in scoring
Risk Score (0–100)
Weight	Component
...
LightGBM	4.5+
PyTorch	2.4+
PyTorch Forecasting	1.1+ (TFT)
Torch Geometric	2.6+ (GNN)
scikit-learn	1.5+
SHAP	0.45+
Infrastructure
Technology	Purpose
...
Weather & Climate
Source	Data	API Key
AEMET	Real-time weather observations, CAP alerts, wildfire danger index	AEMET_API_KEY (required)
Open-Meteo	Hourly/daily forecasts, historical archive, ensemble forecasts, flood river discharge	Free
ECMWF Seasonal	3–6 month temperature and precipitation anomaly outlooks (via Copernicus CDS)	CDSAPI_KEY
Seismic
Source	Data	API Key
IGN	Spanish seismic catalog — earthquake locations, magnitudes, depths (90-day window)	Free
USGS	Iberian Peninsula earthquake data, GeoJSON feed	Free
Fire & Vegetation
Source	Data	API Key
NASA FIRMS	Active fire hotspots from VIIRS and MODIS satellites (1-day data, Spain bbox)	FIRMS_MAP_KEY (required)
Copernicus Land / NDVI	NDVI300 vegetation health index via WMS for fire and drought stress	Free
NASA POWER	Solar irradiance, temperature extremes, precipitation, and evapotranspiration (30-day lag)	Free
Air Quality
Source	Data	API Key
OpenAQ	Ground-level sensor measurements: PM2.5, PM10, NO2, O3, CO, SO2, NO (25 km radius)	OPENAQ_API_KEY
Copernicus CAMS	Atmospheric quality forecasts: PM2.5, PM10, O3, NO2, CO	Free
Flood & Water
Source	Data	API Key
Copernicus EFAS	European flood indicators and 7-day river discharge forecasts	Free
MITECO / ArcGIS	Live reservoir capacity for 374 reservoirs across 16 peninsular basins (weekly)	Free
SAIH — Ebro	Real-time river flow and gauge readings — Ebro basin	Free
SAIH — Segura	Real-time river flow and gauge readings — Segura basin	Free
SAIH — Júcar	Real-time river flow and gauge readings — Júcar basin	Free
SAIH — Guadalquivir	Real-time river flow and gauge readings — Guadalquivir basin	Free
SAIH — Tajo	Real-time river flow and gauge readings — Tajo basin	Free
SAIH — Duero	Real-time river flow and gauge readings — Duero basin	Free
SAIH — Cantábrico	Real-time river flow and gauge readings — Norte basin	Free
SAIH — Guadiana	Real-time river flow and gauge readings — Guadiana basin	Free
SAIH — Mediterráneo	Real-time river flow and gauge readings — Sur basin	Free
Emergency & Infrastructure
Source	Data	API Key
Copernicus EMS	Active disaster and emergency activation perimeters (RSS)	Free
REE	Spanish electricity demand and generation mix (solar, wind, nuclear, hydro, etc.)	Free
Demographics & Geography
Source	Data	API Key
INE	Province population, age distribution, and gender breakdown for all 52 provinces	Free
IGN GeoJSON	Spain province boundaries (WGS84, INE-coded) — bundled static file	—
ARPSI / MITECO	Areas of Significant Flood Risk (ARPSI) zone polygons (GeoJSON, EPSG:25830 / 4326)	—
Prerequisites
Node.js 22+
Python 3.12+
PostgreSQL 16+ (or use Docker)
API keys (required):
AEMET OpenData — weather data and CAP alerts
NASA FIRMS — active fire hotspots
API keys (optional — enhance coverage):
OpenAQ — ground-level air quality measurements
Copernicus CDS — ECMWF seasonal forecasts
Getting Started
1. Clone and install
...
License
MIT — Copyright (c) 2026 Javier de Jesus
